...
selected_joints = {
    ...
    # 31
    '31': np.concatenate((np.arange(0, 11), [91, 95, 96, 99, 100, 103, 104, 107, 108, 111], [112, 116, 117, 120, 121, 124, 125, 128, 129, 132]), axis=0),
    '27': np.array(list(range(27)))  # 27
}
...
def gendata(data_path, label_path, out_path, part='train', config='27'):
    ...
    fp = np.zeros((len(data), max_frame, num_joints,
                  num_channels, max_body_true), dtype=np.float32)
...
if __name__ == '__main__':
    ...
    # 'train_npy/npy', 'va_npy/npy'
    parser.add_argument('--data_path', default='/data/sign/test_npy/npy')
